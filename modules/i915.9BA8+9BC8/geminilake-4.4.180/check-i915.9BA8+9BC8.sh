...
echo -n "Loading module i915.9BA8+9BC8 -> "
[ `/sbin/lsmod | grep -i i915.9BA8+9BC8 | wc -l` -gt 0 ] && echo "Module i915.9BA8+9BC8 loaded succesfully" || echo "Module i915.9BA8+9BC8 is not loaded"
